...
// deinterleaveASM performs byte deinterleaving using SSE2 SIMD instructions.
// Input is split format: [even bytes | odd bytes]
// Output is interleaved: [e0,o0,e1,o1,e2,o2,...]
// Uses PUNPCKLBW/PUNPCKHBW for efficient byte interleaving.
//
//go:noescape
func deinterleaveASM(dst, src []byte)

// interleaveASM performs byte interleaving using SSE2 SIMD instructions.
